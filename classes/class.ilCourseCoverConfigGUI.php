<?php
/**
 * Class ilCourseCoverConfigGUI
 * @author            Roberto Pasini <bonjour@kalamun.net>
 * @ilCtrl_IsCalledBy ilCourseCoverConfigGUI: ilObjComponentSettingsGUI
 */

 class ilCourseCoverConfigGUI extends ilPluginConfigGUI {

    const PLUGIN_CLASS_NAME = ilCourseCoverPlugin::class;
    ...
    public function __construct()
    {
      global $DIC;
      $this->dic = $DIC;
      $this->plugin = ilCourseCoverPlugin::getInstance();
